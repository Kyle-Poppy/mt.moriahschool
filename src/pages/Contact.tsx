...
export default function Contact() {
  ...
  useEffect(() => {
    // Initialize EmailJS securely on component load
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Trigger success state, empty form, and start a 3-second cooldown guard
      setSubmitted(true)
      ...
      // Show the exact error text from EmailJS if available to make debugging easy
      setErrorMessage(error?.text || 'Failed to send message. Please check your network or ad-blocker.')
      setIsSubmitting(false)
    }
  }
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button type="submit" disabled={isSubmitting}
                    className="w-full bg-primary-500 hover:bg-primary-600 disabled:bg-gray-400 text-white font-semibold py-3 rounded-lg transition-colors">
