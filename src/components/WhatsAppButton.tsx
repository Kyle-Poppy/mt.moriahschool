  ...
  return (
    ...
    >
      <div className="relative w-24 h-24">
        ...
        {/* WhatsApp Button */}
        <div className="absolute bottom-0 right-0 w-14 h-14 rounded-full shadow-xl flex items-center justify-center bg-green-500 hover:bg-green-600 transition-colors">
